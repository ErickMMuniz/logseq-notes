...
- Sobre la #tesis.
	...
	-
- Una forma de agrupar a indices de tiempo en numpy, se puede usar la función de `np.resample` [link](https://www.geeksforgeeks.org/how-to-group-data-by-time-intervals-in-python-pandas/) #Python
